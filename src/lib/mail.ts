      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        <tr>
          <td style="background:#ef6a9f;padding:36px 40px;text-align:center;">
            <img src="${LOGO_DATA_URI}" alt="JNM 2026" width="200" style="display:block;margin:0 auto 14px;max-width:200px;" />
        ...
        <tr>
          <td style="padding:24px 40px;text-align:center;">
            <p style="margin:0 0 6px;font-size:13px;color:#999;">Toulouse · 26–29 mai 2026</p>
            <p style="margin:0;font-size:12px;color:#bbb;">
              <a href="${siteUrl}/app" style="color:#ef6a9f;text-decoration:none;">Accéder à mon espace</a>
            </p>
          </td>
        </tr>
      </table>
...
export async function sendWelcomeEmail({
    ...
    const body = `
        <p style="margin:0 0 8px;font-size:24px;font-weight:700;color:#1a1a1a;">Bienvenue${name}&nbsp;! ✈️</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff5f9;border:1px solid #ffd6e8;border-radius:12px;margin-bottom:28px;">
            <tr><td style="padding:20px 24px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr><td style="padding:8px 0;border-bottom:1px solid #ffd6e8;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td align="center">
                <a href="${siteUrl}/app" style="display:inline-block;background:#ef6a9f;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:50px;letter-spacing:0.5px;">
