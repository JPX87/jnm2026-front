  ...
  return (
    <main className="home relative">
      <Slice absolute first>
        <h1 className="text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold my-[20px] sm:my-[30px] md:my-[50px] drop-shadow-lg">EMBARQUEMENT DANS</h1>
        <Countdown className="mx-auto" targetDate={targetDate} />
      </Slice>
      <Slice absolute>
        <div className="relative w-10/12 flex flex-col gap-3 py-8 sm:py-10 md:py-14 px-4 sm:px-6 justify-center rounded-3xl bg-(--color-tertiary) text-(--color-secondary) dark:text-(--color-seconde-black) m-auto">
          <h1 className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold my-[20px] sm:my-[30px] md:my-[50px] transition-all">DES QUESTIONS SUR LES JNM ?</h1>
